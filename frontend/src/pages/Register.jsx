    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-medical-50 flex items-center justify-center p-4">
      <div className="max-w-6xl w-full">
        <div className="grid md:grid-cols-2 gap-0 bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Image Side */}
          <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-orange-400 to-orange-300 p-12">
            <div className="text-center">
              <img 
                src={role === 'CLIENT' ? '/photos/client.webp' : '/photos/img1.jpg'}
                alt="Medicine" 
              ...
              <p className="text-orange-50 text-lg">
                Join us to find medicines at nearby pharmacies
              </p>
            </div>
          </div>
